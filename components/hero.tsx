"use client";
import { ParticleCanvas } from '@/hooks/particles';
      ...
      <div className="max-w-7xl mx-auto px-6 pt-32">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            >
              Specializing in Javascript (React and Nextjs) Typescript, 
              Python (Django), data analysis (python & R), and C++. Building modern/trendy scalable apps with current tech stacks.
            </motion.p>
            <motion.button
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}    
            ...
            bg-surface border border-white/10 hover:border-primary/30 transition-all group'
          ...
          >
            ...
            >
              ...
              className='absolute inset-0 rounded-3xl bg-gradient-to-r from-primary/30 via-secondary/30 to-tertiary/30 
              opacity-50'
              />
              ...
              className='realtive w-full aspect-square rounded-3xl overflow-hidden 
              border border-white/10 bg-surface backdrop-blur-sm'
