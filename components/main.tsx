...
const projects = [
    ...
    },
    {
        ...
        tech:[
            ...
            {name: "GraphQL", icon: SiGraphql, color: "#E5E5AB"},
        ],
    ...
    return (
        ...
        <section className="py-32 relative id='work'">
            <div className="max-w-7xl mx-auto px-6">
                ...
                className ="flex fle-col items-center mb-20"
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {
                                            project.tech.map((tech, j) => ( 
                                                ...
                                                text-sm border border-white/5 hover:bg-surface transition-colors flex items-center
                                                gap-1.5 group/tech"
